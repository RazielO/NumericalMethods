<script lang="ts">
	// UI Imports
	import Info from '$lib/algorithms/integration/simpson38/Description.md';
	import { TextInput, NumberInput, Grid, Button } from '@svelteuidev/core';

	// Algorithm related imports
	import { Simpson38 } from '$lib/algorithms/integration/simpson38/algorithm';
	...
	let title = 'Simpson 3/8';

	// Algorithm related variables
	let f: string;
	let a: number;
	let b: number;
	let simpson: Simpson38;
	let result: number;

	function solve() {
		simpson = new Simpson38(f, a, b);
