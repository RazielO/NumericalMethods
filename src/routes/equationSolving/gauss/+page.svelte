<script lang="ts">
	...
	import Info from '$lib/algorithms/equationSolving/gauss/Description.md';

	// Algorithm imports
	import { Gauss } from '$lib/algorithms/equationSolving/gauss/algorithm';
